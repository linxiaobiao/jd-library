...
Page({
    ...
    onShow: function() {
        var e = this;
        if (wx.getStorageSync("isOrderLocDetail") || "wait4Payment" == this.data.functionId || "wait4Delivery" == this.data.functionId) {
            this.setData({
                pageNum: 1
            });
            ...
            this.onceGetOrderData(t), wx.removeStorageSync("isOrderLocDetail");
        } else wx.getStorage({
    ...
    toViewPage: function(e) {
        var t = this;
        if (null != e && e.orderList) if (e.orderList.length <= 0) this.data.firstHasData ? this.data.noMore = !0 : this.data.noMore = !1, 
        t.setData({
            ...
            t.setData({
                ...
                orderList: a,
                home_orderdetail_confirm618: e.home_orderdetail_confirm618,
                home_orderlist_sendPay618: e.home_orderlist_sendPay618
            });
        }
        wx.hideToast();
    },
