...
Page({
    ...
    dataInit: function(a, e) {
        ...
        if (a && "string" != typeof a) if (a.loginFlag && "false" != a.loginFlag) {
            ...
            a.data.discount && "" != r && a.data.couponTypeMsg || (this.setData({
                ...
                buttonTxt: "不可领取",
                tabFun: ""
            }), console.log("不可领取日志：=====data=====", a), console.log("不可领取日志：=====couponDateRange=====", r)), 
            a.data.couponDateRange = r, this.setData({
                item: a.data
            });
        } else {
            var n = o.data.couponParam.key, s = o.data.couponParam.roleId;
            o.setData({
                isLogined: !1
            }), n && s && (wx.removeStorageSync("getCouponParam"), wx.setStorage({
                key: "getCouponParam",
                data: {
                    key: n,
                    roleId: s
    ...
    tapBtnGetCoupon: function() {
        var e = this, o = e.data.couponParam.key, r = e.data.couponParam.roleId, n = a.globalData.wxCookie, s = n.getCookie("shshshfp"), i = n.getCookie("shshshfpa"), u = n.getCookie("shshshfpb"), d = a.globalRequestUrl + "/coupon/coupon/postAloneCoupon";
        t.request({
            url: d,
            data: {
                key: o,
