...
Page({
            ...
            if (s.messagePush({
                ...
                wx.showToast({
                    ...
                    success: function(e) {
                        ...
                        i && i.data && i.data.presaleData && i.data.presaleData.presaleStepPay && 2 == i.data.presaleData.presaleStepPay && (i.data.resetDefaultPhoneNum = !0), 
                        wx.navigateBack();
                    },
                    complete: function() {
                        wx.hideToast();
                ...
                var d = getCurrentPages(), I = d[d.length - 2];
                I && I.data && I.data.presaleData && I.data.presaleData.presaleStepPay && 2 == I.data.presaleData.presaleStepPay && (I.data.resetDefaultPhoneNum = !0), 
                wx.navigateBack();
            }
        } catch (e) {
    ...
    onLoad: function(t) {
        ...
        (0, a.request)({
            ...
            fail: function(e) {
                (0, a.reportErr)("distribution payShipment.json: " + e), wx.redirectTo({
                    url: "../error/error"
                });
            }
        }), r.set({
