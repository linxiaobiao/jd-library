...
Page({
        ...
        s.setData({
            ...
            fail: function() {
                e.request({
                    ...
                    fail: function(r) {
                        s.goErrorPage(), e.reportErr(encodeURIComponent("四级地址选择首次数据onload请求request异常，具体信息：") + r.errMsg);
                    }
                });
            }
        }), wx.getSystemInfo({
    ...
    goErrorPage: function() {
        wx.redirectTo({
            url: "../error/error?thisBarTitle=地址选择"
        });
    },
    onShow: function() {
        r.pv();
    ...
    resetChoice: function(r) {
        ...
        e.request({
            ...
            fail: function(r) {
                a.goErrorPage(), e.reportErr(encodeURIComponent("四级地址选择resetChoice数据请求request异常，具体信息：") + r.errMsg);
            }
        });
    },
