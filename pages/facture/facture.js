...
Page({
    ...
    contentMessageShow: function() {
        var e = void 0, t = void 0, n = void 0, o = void 0, i = void 0, a = void 0, s = void 0, c = void 0, l = void 0, r = void 0, d = void 0, v = void 0;
        ...
        r = o[t].messageCss, d = o[t].detailMsgText, v = o[t].detailMsgCss, this.setData({
            electroContentMessage: l,
            electroContentMessageCss: r,
            electroDetailMsg: d,
    ...
    confirmFacture: function(e) {
        ...
        (0, t.request)({
            ...
            success: function(t) {
                ...
                o && o.data && o.data.presaleData && o.data.presaleData.presaleStepPay && 2 == o.data.presaleData.presaleStepPay && (o.data.resetDefaultPhoneNum = !0), 
                wx.navigateBack();
            },
            fail: function(e) {
    ...
    getInvoiceType: function(e) {
        ...
        switch (parseInt(e)) {
          case 1:
            this.setData({
                "factureGoods.invContentList": t.normalInvoice && t.normalInvoice.invContentList
            });
            break;

          case 2:
            this.setData({
                "factureGoods.invContentList": t.vatInvoice && t.vatInvoice.invContentList
            });
            break;

          case 3:
            this.setData({
                "factureGoods.invContentList": t.electroInvoice && t.electroInvoice.invContentList
            });
            break;
