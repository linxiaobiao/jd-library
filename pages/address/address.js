...
Page({
    ...
    onLoad: function(t) {
        var s = this;
        s.setData({
            addressType: t.addressType ? t.addressType : ""
            ...
            defaultFlag: t.defaultFlag ? t.defaultFlag : 0
        }), a.set({
            urlParam: t,
            title: "编辑收货地址",
    ...
    getRequestUrl: function(e) {
        ...
        if (a.curRegionId = t[e - 1] && t[e - 1].regionId, e > 1) {
            var s = t[e - 2] && t[e - 2].regionId;
                ...
                e.request({
                    ...
                    success: function() {
                        if (0 == d.data.chooseAddressFlag) {
                            ...
                            a && a.data && a.data.presaleData && a.data.presaleData.presaleStepPay && 2 == a.data.presaleData.presaleStepPay && (a.data.resetDefaultPhoneNum = !0), 
                            wx.navigateBack();
                        }
                        d.data.chooseAddressFlag++;
                    },
                    fail: function(a) {
